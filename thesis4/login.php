...
<head>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $idsql = "SELECT * FROM users WHERE USERNAME='$username' AND PASSWORD='$passwordhash'";
    ...
    <div class="login-row">
      ...
      <div class="col form">
        <div class="login-form">
          ...
          <hr>
          <center><button type="submit" class="newaccount" onclick="vaccinationformfunction()">Register New Account</button></center>
          <script>
            function vaccinationformfunction(){
          ...
          <div>
            ...
            <div>
              <center><a href="adminlogin.php" class="admin-text">Admin Login</a></center>
            </div>
          </div>
        </div>
      </div>
